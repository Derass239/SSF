...
struct _R: Rswift.Validatable {
  ...
  struct storyboard: Rswift.Validatable {
    ...
    struct main: Rswift.StoryboardResourceWithInitialControllerType, Rswift.Validatable {
      ...
      let bundle = R.hostingBundle
      let contactDetailViewController = StoryboardViewControllerResource<ContactDetailViewController>(identifier: "ContactDetailViewController")
      ...
      func contactDetailViewController(_: Void = ()) -> ContactDetailViewController? {
        return UIKit.UIStoryboard(resource: self).instantiateViewController(withResource: contactDetailViewController)
      }
      ...
      static func validate() throws {
        ...
        if UIKit.UIImage(named: "list.dash", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'list.dash' is used in storyboard 'Main', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
        if _R.storyboard.main().contactDetailViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'contactDetailViewController' could not be loaded from storyboard 'Main' as 'ContactDetailViewController'.") }
        if _R.storyboard.main().contactViewController() == nil { throw Rswift.ValidationError(description:"[R.swift] ViewController with identifier 'contactViewController' could not be loaded from storyboard 'Main' as 'ContactViewController'.") }
